                ...
                >
                  <div className="flex items-center justify-between px-6 py-5 border-b border-cyber-border bg-cyber-surface flex-shrink-0">
                    <div className="flex items-center gap-2.5">
                      ...
                      <h2 className="text-sm font-semibold text-cyber-text">Parametres</h2>
                    </div>
                    <button
                      onClick={() => setIsOpen(false)}
                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-8">
                    <section>
                      <div className="mb-3">
                        ...
                        <p className="text-[11px] text-cyber-text-3 mt-1 leading-normal">
                          Definit la capacite maximale de la fenetre de contexte cible.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          ...
                          <p className="text-[11px] text-cyber-text-3 mt-1 leading-normal max-w-[220px]">
                            Affiche un avertissement quand le total depasse ce pourcentage.
                          </p>
                        </div>
                    ...
                    <section>
                      <div className="mb-3">
                        ...
                        <div className="flex items-center gap-1.5 mt-1 text-cyber-text-3">
                          ...
                          <span className="text-[10px]">0 = desactive</span>
                        </div>
                      </div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full pl-4 pr-14 py-2.5 rounded-lg text-xs font-mono bg-cyber-surface-2 border border-cyber-border text-cyber-text placeholder-cyber-text-3/50 focus:outline-none focus:border-cyber-cyan/50 focus:ring-1 focus:ring-cyber-cyan/20 transition-colors"
                    ...
                    <section>
                      <div className="mb-3">
                        ...
                        <p className="text-[11px] text-cyber-text-3 mt-1 leading-normal">
                          Ameliore le rate-limit GitHub pour les scans frequents.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        <input
                          ...
                          className="w-full px-4 py-2.5 rounded-lg text-xs font-mono bg-cyber-surface-2 border border-cyber-border text-cyber-text placeholder-cyber-text-3/50 focus:outline-none focus:border-cyber-cyan/50 focus:ring-1 focus:ring-cyber-cyan/20 transition-colors"
                          placeholder="ghp_..."
                        />
                        <button
                          onClick={() => onChangeGithubToken('')}
                          className="text-[11px] text-cyber-text-3 hover:text-cyber-cyan transition-colors"
                        >
                          Effacer le token
                        </button>
                      </div>
                    ...
                    <div className="bg-cyber-cyan/5 border border-cyber-cyan/10 rounded-xl p-4">
                      <p className="text-[11px] text-cyber-text-2 leading-relaxed">
                        <strong className="text-cyber-cyan font-semibold block mb-1">
                          Popup de confirmation :
                        </strong>
                        Une alerte apparait quand la selection depasse{' '}
